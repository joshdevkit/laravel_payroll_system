...
export default function Index({
    ...
    const [editing, setEditing] =
        useState<SssDeduction | null>(null);

    const [form, setForm] =
        useState<SssDeductionForm>(emptyForm);
    ...
    const remove = (item: SssDeduction) => {
        ...
        if (
            !window.confirm(
                `Delete the SSS deduction for ${employeeName}?`
            )
        ) {
            return;
        }
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                            Assign an SSS deduction to a specific
                            employee and choose the exact payroll
                            date when the deduction should be applied.
                        </p>
                    </div>
                    ...
                    <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">
                                SSS is deducted only when the payroll
                                pay date matches the configured
                                deduction date.
                            </p>
                        </div>
                    ...
                    >
                        <div className="mb-5">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Assign the SSS deduction to a
                                specific employee and payroll date.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <label className="block text-sm font-medium">
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">
                                    The SSS amount will only be
                                    deducted from a payroll whose
                                    pay date matches this date.
                                </p>
                            </label>
