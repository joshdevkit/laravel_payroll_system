                            ...
                            <>
                                    ...
                                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                        <div>
                                            ...
                                            <CardDescription className="mt-1 max-w-2xl">
                                                SSS uses the contribution table
                                                and deducts the full monthly
                                                employee share only on the
                                                selected cutoff.
                                            </CardDescription>
                                        </div>
                                ...
                                <CardContent className="mt-6 p-0">
                                    ...
                                    <p className="mt-3 text-xs text-muted-foreground">
                                        The employer share and EC are
                                        employer-paid and are never included in
                                        employee net pay.
                                    </p>
                                </CardContent>
                            </>
                                    ...
                                    <Card className="border-dashed">
                                        <CardHeader className="pb-3">
                                            ...
                                            <CardDescription>
                                                ...
                                                this employee's monthly
                                                contribution will be deducted.
                                                No cutoff means no deduction.
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="pt-0">
