...
export default function Show({ payrollRun }: { payrollRun: PayrollRun }) {
    ...
    useEffect(() => {
        ...
        const escape = (event: KeyboardEvent) => { if (event.key === 'Escape') window.history.back(); };
    ...
    const confirmPayroll = () => {
        ...
        setConfirming(true);
        router.patch(`/payroll/${payrollRun.id}/confirm`, {}, { preserveScroll: true, onFinish: () => setConfirming(false) });
    };
