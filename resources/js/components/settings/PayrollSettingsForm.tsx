...
export function PayrollSettingsForm({
    ...
    const save = () => {
        ...
        const payload = {
            ...
            monthly_daily_rate_divisor: Math.max(
                1,
    ...
    return (
        <Card className="mt-6">
            <CardHeader>
                ...
                <CardDescription>
                    Payroll Run uses these saved values. Employee rates come
            ...
            <CardContent className="space-y-8">
                <section className="space-y-3">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Enable or disable individual payroll components.
                        </p>
                    </div>
                ...
                <section className="space-y-4">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Configure the overtime multiplier and minimum
                            qualifying minutes.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                        ...
                        <Field label="Monthly daily-rate divisor">
                            <Input
                                type="number"
                                min="1"
                                step="0.01"
                ...
                <section className="space-y-4">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            The multiplier is applied to the employee's actual
                            hourly rate.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                        <Field label="Night start">
                            <Input
                                type="time"
                                value={settings.night_diff_start.slice(0, 5)}
                                onChange={(e) =>
                                    set('night_diff_start', e.target.value)
                                }
                            />
                        </Field>
                        ...
                        <Field label="Night end">
                            <Input
                                type="time"
                                value={settings.night_diff_end.slice(0, 5)}
                                onChange={(e) =>
                                    set('night_diff_end', e.target.value)
                                }
                            />
                        </Field>

                        <Field label="ND multiplier">
                            <Input
                                type="number"
                                min="0"
                                step="0.01"
                ...
                <section className="space-y-4">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Configure total holiday pay multipliers.
                        </p>
                    </div>

                    <div className="grid gap-4 sm:grid-cols-2">
                        <Field label="Regular holiday multiplier">
                            <Input
                                type="number"
                                min="0"
                                step="0.05"
                        ...
                        <Field label="Special non-working holiday multiplier">
                            <Input
                                type="number"
                                min="0"
                                step="0.05"
                                value={settings.holiday_special_multiplier}
                                onChange={(e) =>
                                    set(
                ...
                <section className="space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Configure where the header row starts in each
                                import file. Data is read from the row
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <Field
                            label="Employee Attendance starting cell"
                            hint="Example: C3 means headers are on row 3 starting in column C."
                        >
                            <Input
                                value={settings.attendance_import_start_cell}
                                onChange={(e) =>
                                    set(
                        ...
                        <Field
                            label="Bulk Schedule starting cell"
                            hint="Example: C3 means headers are on row 3 starting in column C."
                        >
                            <Input
                                value={settings.schedule_import_start_cell}
                                onChange={(e) =>
                                    set(
