...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('sss_contributions', function (Blueprint $table) {
            ...
            $table->decimal('monthly_compensation', 14, 2)->default(0);
            $table->decimal('monthly_salary_credit', 14, 2)->default(0);
            ...
            $table->index(['sss_contribution_table_id'], 'sss_contributions_schedule_idx');
        });
    }
